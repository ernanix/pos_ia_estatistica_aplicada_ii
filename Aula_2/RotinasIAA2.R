...
load("D:/Cursos/Pos_IA/Estatistica_aplicada_II/Aula_2/pib.RData")
...
energia <- read_excel("D:/Cursos/Pos_IA/Estatistica_aplicada_II/Aula_3/energia.xls")
...
load("D:/Cursos/Pos_IA/Estatistica_aplicada_II/Aula_2/diesel.RData")
...
load("D:/Cursos/Pos_IA/Estatistica_aplicada_II/Aula_2/varejo.RData")


varejo=ts(varejo[2], start = c(2000,1), end = c(2022,4), frequency = 12)
plot(varejo)

autoplot(varejo) +
  theme_bw()

# divisão de janelas - Valores mudados em sala
treinovarejo=window(varejo, start=c(2000,1), end=c(2010,12))
length(treinovarejo)
testevarejo=window(varejo,start=c(2011,1), end=c(2012,6))
length(testevarejo)
...
prevvarejo=forecast::forecast(arimavarejo, h=18)
